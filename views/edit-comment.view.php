...
<main class="flex-1 bg-gray-50 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-sm p-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-6">Editar Comentario para: <?= htmlspecialchars($book['title']) ?> de <?= htmlspecialchars($book['author']) ?></h1>

            <form method="POST" action="/save-edit-comment" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" required
                              ...
                              rows="4" placeholder="Edita tu comentario aquí..."><?= htmlspecialchars($comment['description']) ?></textarea>
                </div>
